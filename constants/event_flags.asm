...
; Ilex Heart 11/48
	...
	const EVENT_ILEX_FOREST_HEART_RARE_CANDY
	const EVENT_ILEX_FOREST_HEART_NUGGET
	const EVENT_ILEX_FOREST_HEART_LEAFSTONE
	const EVENT_ILEX_FOREST_HEART_HIDDEN_DUSK_STONE
	const EVENT_ILEX_FOREST_HEART_HIDDEN_RARE_CANDY
...
; Dark Cave Violet Entrance Update 13/48
	const EVENT_BEAT_HIKER_KARL
	const EVENT_BEAT_CAMPER_HARVEY

; Whirl Island Lugia Chamber Update 14/48
	const EVENT_WHIRL_ISLAND_LUGIA_ROOM_VORTEX_DRIVE

; Mount Mortar Strength Puzzle 20/48
	const EVENT_MOUNT_STRENGTH_PUZZLE_LIFTING_BELT
	const EVENT_MOUNT_STRENGTH_PUZZLE_RARE_CANDY
	const EVENT_MOUNT_STRENGTH_PUZZLE_CARBOS
	const EVENT_MOUNT_STRENGTH_PUZZLE_NUGGET
	const EVENT_BEAT_TEACHER_MIRIAM
