...
Route30_MapEvents:
	...
	object_event  4, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerYoungsterJoey, EVENT_ROUTE_30_YOUNGSTER_JOEY
