...
JohtoGrassWildMons:
	...
	db 25, KOFFING, 	 15,  18
	db 20, FENNEKIN, 	  5,   5
	db 20, KITTRING, 	 15,  18
	db  5, MISDREAVUS, 	 15,  18
	db  4, MISDREAVUS, 	 15,  18
	db  1, MISDREAVUS, 	 15,  18
	; day
	;  %, species,		min, max
	db 25, SLUGMA, 	     15,  18
	db 25, KOFFING, 	 15,  18
	...
	db 30, INKAY,   	 12,  14
	db 30, NATU,    	 12,  14
	db 10, SMEARGLE, 	 12,  14
	db 10, SPIRITOMB, 	 12,  14
	db 10, NOIBAT,  	 12,  14
	db  5, INKAY,   	 12,  14
	db  5, NATU,    	 12,  14
	; day
	...
	db 30, SLOWPOKE, 	 10,  10
	db 20, SLOWPOKE, 	 10,  10
	db 10, SLOWPOKE, 	 10,  10
	db  5, SLOWPOKE, 	 10,  10
	db  4, SLOWPOKE, 	 10,  10
	db  1, SLOWPOKE, 	 10,  10
	; day
	...
	;  %, species,		min, max
	db 30, MARILL,  	 24,  28
	db 30, GROWLITHE, 	 24,  28
	db 20, DUNSPARCE,  	 24,  28
	db 10, TEDDIURSA,    24,  28
	db  5, MAGMAR, 	     24,  28
	db  4, ELECTABUZZ, 	 24,  28
	db  1, ELECTABUZZ, 	 24,  28
	; day
	;  %, species,		min, max
	db 30, MARILL,  	 24,  28
	db 30, GROWLITHE, 	 24,  28
	...
	; morn
	;  %, species,		min, max
	db 20, HOUNDOUR, 	 18,  23
	db 20, CUBONE,  	 18,  23
	db 15, SLUGMA,  	 18,  23
	db 15, ONIX,    	 18,  23
	db 10, TEDDIURSA,  	 18,  23
	db 10, ELECTABUZZ,	 18,  23
	db 10, MAGMAR,  	 18,  23
	; day
	;  %, species,		min, max
	db 20, HOUNDOUR, 	 18,  23
	...
	db 10, MALAMAR,   	 30,  35
	db 10, DITTO,   	 30,  35
	db 10, KABUTOPS, 	 30,  35
	db 10, AERODACTYL, 	 30,  35
	; day
	;  %, species,		min, max
	db 20, GOLEM,   	 30,  35
	db 20, CORSOLA, 	 30,  35
	...
	; morn
	;  %, species,		min, max
	db 30, JIGGLYPUFF, 	 14,  17
	db 15, MAGNEMITE, 	 14,  17
	db 20, SENTRET, 	 14,  17
	db 15, SWABLU,  	 14,  17
	db 10, MAREEP,  	 14,  17
	db  5, HOOTHOOT, 	 14,  17
	...
	;  %, species,		min, max
	db 30, SENTRET,  	 14,  17
	db 30, GROWLITHE, 	 14,  17
	db 10, STANTLER, 	 14,  17
	db 10, MURKROW,  	 14,  17
	db 10, SENTRET,  	 14,  17
	db  5, HOOTHOOT, 	 14,  17
	db  5, SUDOWOODO, 	 14,  17
	; day
	;  %, species,		min, max
	db 30, SENTRET,  	 14,  17
	db 30, GROWLITHE, 	 14,  17
	...
	; nite
	;  %, species,		min, max
	db 30, HOOTHOOT,  	 17,  19
	db 30, SPINARAK,  	 17,  21
	db 10, NOCTOWL,  	 20,  22
	db 10, MILTANK,  	 17,  22
	db 10, GROWLITHE,  	 17,  22
	db  5, ARIADOS,  	 22,  22
	...
	; morn
	;  %, species,		min, max
	db 30, SKIPLOOM, 	 26,  30
	db 30, POLIWHIRL, 	 26,  30
	db 20, FURRET,  	 26,  30
	db 10, NOCTOWL,  	 26,  30
	db  5, CLEFAIRY, 	  5,  30
	db  4, CLEFAIRY, 	  5,  30
	...
	; morn
	;  %, species,		min, max
	db 20, SNEASLER, 	 90,  90
	db 20, ALTARIA, 	 90,  90
	db 20, ARCANINE, 	 90,  90
	db 10, SKARMORY, 	 90,  90
	db 10, TYRANITAR, 	 90,  90
	db 10, URSALUNA, 	 90,  90
	db 10, GLISCOR, 	 90,  90
	; day
	;  %, species,		min, max
	db 20, SNEASLER, 	 90,  90
