...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move GUNK_SHOT,    EFFECT_POISON_HIT,        120, POISON,        SPECIAL,   80,  5,  30
	...
	move BOOMBURST,    EFFECT_NORMAL_HIT,        140, NORMAL,        SPECIAL,  100, 10,   0
	move FLY,          EFFECT_NORMAL_HIT,         90, FLYING,        PHYSICAL, 100, 15,   0
	...
	move STONE_AXE,    EFFECT_NORMAL_HIT,         90, ROCK,          PHYSICAL, 100, 20,   0
	...
	move DRAGON_PULSE, EFFECT_NORMAL_HIT,         85, DRAGON,        SPECIAL,  100, 10,  30
	...
	move TACHYON_RAY,  EFFECT_ALWAYS_HIT,         50, STEEL,         SPECIAL,  100, 20,   0
	...
	move BULLDOZE,     EFFECT_SPEED_DOWN_HIT,     60, GROUND,        PHYSICAL, 100, 25, 100
	...
	move EMPTY,        EFFECT_FLY,                40, DARK,          PHYSICAL, 100, 10, 100
	move DIRE_CLAW,    EFFECT_DIRE_CLAW,          60, POISON,        PHYSICAL, 100, 15,  50
	...
	move SAND_SCORCH,  EFFECT_BURN_HIT,           70, GROUND,        SPECIAL,  100, 10,  30
	move HEAD_SMASH,   EFFECT_RECOIL_HIT,        150, ROCK,          PHYSICAL,  80,  5,   0
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,        SPECIAL,   95,  5,   0
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING,      SPECIAL,   70,  5,   0
	...
	move ASTONISH,     EFFECT_FLINCH_HIT,         30, GHOST,         PHYSICAL, 100, 30,  30
	...
	move BOUNCE,       EFFECT_PARALYZE_HIT,       85, FLYING,        PHYSICAL,  85,  5,  30
	...
	move AQUA_JET,     EFFECT_PRIORITY_HIT,       40, WATER,         PHYSICAL, 100, 30,   0
	...
	move SHELL_SMASH,  EFFECT_SHELL_SMASH,         0, NORMAL,        STATUS,   100, 40,   0
