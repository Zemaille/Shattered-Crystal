...
; ESCAPE_ROPE
	item_attribute 10, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; REPEL
...
; KINGS_ROCK
	item_attribute 1000, HELD_FLINCH, 30, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PERSIM_BERRY
...
; Teleporter
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; LEPPA_BERRY
	item_attribute 0, HELD_RESTORE_PP, -1, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; DRAGON_SCALE
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; BERSERK_GENE
	item_attribute 500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
