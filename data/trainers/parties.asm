...
CooltrainerMGroup:
	...
	db 25, FLAREON, CHARCOAL, SUNNY_DAY, EMBER, NO_MOVE, NO_MOVE
	db 25, SKIPLOOM, LUM_BERRY, SYNTHESIS, SLEEP_POWDER, SOLARBEAM, NO_MOVE
	db 25, CHARMELEON, LUM_BERRY, CUT, FIRE_FANG, SCRATCH, NO_MOVE
	db 25, HOUNDOUR, BERRY_JUICE, EMBER, SNARL, SUNNY_DAY, NO_MOVE
	db 25, KADABRA, TWISTEDSPOON, CONFUSION, FLASH, NO_MOVE, NO_MOVE
	db 25, GRAVELER, BERRY_JUICE, ROCK_THROW, THUNDERPUNCH, BODY_SLAM, CURSE
	db -1 ; end
...
BeautyGroup:
	...
	db 25, TEDDIURSA, BERRY_JUICE, SWORDS_DANCE, CUT, AI_RETURN, NO_MOVE 
	db 25, MAREEP, MAGNET, THUNDER_WAVE, SPARK, SIGNAL_BEAM, NO_MOVE
	db 25, PONYTA, LUM_BERRY, PSYBEAM, STOMP, DISARM_VOICE, AI_RETURN
	db 25, JYNX, LUM_BERRY, POWDER_SNOW, CONFUSION, SING, SWAGGER
	db -1 ; end
...
PokemaniacGroup:
	...
	db 25, EXEGGCUTE, BERRY_JUICE, LEECH_SEED, HYPNOSIS, MEGA_DRAIN, CONFUSION
	db 25, TOGETIC, LUM_BERRY, METRONOME, THUNDER_WAVE, NO_MOVE, NO_MOVE
	db 25, DRATINI, LUM_BERRY, THUNDER_WAVE, TWISTER, NO_MOVE, NO_MOVE
	db 25, CUBONE, SITRUS_BERRY, CUT, BULLDOZE, SWORDS_DANCE, NO_MOVE
	db -1
...
BugCatcherGroup:
	...
	db 25, ARAQUANID, BERRY_JUICE, RAIN_DANCE, WATER_PULSE, INFESTATION, NO_MOVE
	db 25, BUTTERFREE, LUM_BERRY, GUST, STRING_SHOT, CONFUSION, SLEEP_POWDER
	db 25, SCIZOR, LUM_BERRY, CUT, FURY_CUTTER, AERIAL_ACE, BULLET_PUNCH
	db -1 ; end
...
FisherGroup:
	...
	db 25, POLITOED, LEFTOVERS, RAIN_DANCE, WATER_PULSE, HYPNOSIS, NO_MOVE
	db 25, SEADRA, LUM_BERRY, WATER_PULSE, SMOKESCREEN, AURORA_BEAM, NO_MOVE
	db 25, WARTORTLE, BERRY_JUICE, BUBBLEBEAM, SHELL_SMASH, CUT, NO_MOVE
	db 25, GYARADOS, BERSERK_GENE, BITE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1
...
CamperGroup:
	...
	db 25, NIDORINO, BERRY_JUICE, CUT, HORN_ATTACK, BULLDOZE, TOXIC
	db 25, YANMA, LUM_BERRY, AIR_CUTTER, DETECT, SUPERSONIC, QUICK_ATTACK
	db 25, MANKEY, SCOPE_LENS, CROSS_CHOP, KARATE_CHOP, NO_MOVE, NO_MOVE
	db 25, MUNCHLAX, LEFTOVERS, CURSE, REST, SLEEP_TALK, TACKLE
	db -1 ; end
