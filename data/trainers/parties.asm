...
LtSurgeGroup:
	...
	db 40, DRAGALGE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 40, MAGNETON,   LOCK_ON, DOUBLE_TEAM, SWIFT, NO_MOVE
	db 40, DRAGALGE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
JanineGroup:
	...
	db 39, CLODSIRE,   FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
BugCatcherGroup:
	...
	db 32, DELPHOX,   NO_MOVE, PURSUIT, NO_MOVE, DOUBLE_TEAM
...
BlackbeltGroup:
	...
	db 36, YAMASK,  DOUBLE_TEAM, NO_MOVE, MUD_SLAP, SWIFT
	db -1 ; end
