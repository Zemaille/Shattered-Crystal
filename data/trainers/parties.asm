...
MortyGroup:
	...
	db 25, GENGAR,     SPORE, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
...
SchoolboyGroup:
	...
	db 35, XATU,       PECK, NO_MOVE, SWIFT, FUTURE_SIGHT
...
PsychicGroup:
	...
	db 17, INKAY,    SPORE, DISABLE, DREAM_EATER, NO_MOVE
	db -1 ; end
	...
	db 24, NATU,       LEER, NO_MOVE, FUTURE_SIGHT, CONFUSE_RAY
...
MysticalmanGroup:
	...
	db 23, INKAY,    DREAM_EATER, SPORE, DISABLE, CONFUSION
