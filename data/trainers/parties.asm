...
MortyGroup:
	...
	db 21, HAUNTER,    SPORE, NO_MOVE, CURSE, NO_MOVE
	db 25, GENGAR,     SPORE, SHADOW_BALL, NO_MOVE, NO_MOVE
	db 23, HAUNTER,    NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
Rival1Group:
	...
	db 30, HAUNTER,    LICK, NO_MOVE, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, NO_MOVE, NO_MOVE, BITE, SCARY_FACE
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     NO_MOVE, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, NO_MOVE, PSYCHIC_M
	db 45, FERALIGATR, NO_MOVE, NO_MOVE, SCARY_FACE, SLASH
	db -1 ; end
...
BurglarGroup:
	...
	db 26, GROWLITHE,  NO_MOVE, EMBER, LEER, TAKE_DOWN
