...
ErikaGroup:
	...
	db 41, GOODRA,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
...
PicnickerGroup:
	...
	db 33, GOODRA,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
	db 33, GOODRA,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, COTTON_SPORE
