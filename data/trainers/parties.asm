...
ChuckGroup:
	...
	db 30, POLIWRATH,  SPORE, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
MistyGroup:
	...
	db 42, ARAQUANID,    SURF, DISABLE, PSYCH_UP, PSYCHIC_M
...
CooltrainerMGroup:
	...
	db 35, ARAQUANID,    CONFUSION, SCREECH, PSYCH_UP, FURY_SWIPES
	db -1 ; end
...
CamperGroup:
	...
	db 34, ARAQUANID,    DISABLE, PSYCHIC_M, SURF, PSYCH_UP
	db -1 ; end
