...
SchoolboyGroup:
	...
	db 35, DRAGALGE,  SCREECH, SONICBOOM, ROLLOUT, LIGHT_SCREEN
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, NO_MOVE, SOFTBOILED
	db -1 ; end
...
SailorGroup:
	...
	db 18, FEEBAS,     BUBBLE, LEER, VICEGRIP, HARDEN
	db 20, FEEBAS,     BUBBLEBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
...
MysticalmanGroup:
	...
	db 25, DRAGALGE,  SCREECH, SONICBOOM, THUNDER, ROLLOUT
	db -1 ; end
