...
ErikaGroup:
	...
	db 46, SHIFTRY, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
...
CooltrainerMGroup:
	...
	db 35, SHIFTRY, WRAP, TOXIC, ACID, RAZOR_LEAF
	...
	db 39, SHIFTRY, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	...
	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, SHIFTRY, WRAP, TOXIC, ACID, RAZOR_LEAF
...
PicnickerGroup:
	...
	db 30, NUZLEAF, SLEEP_POWDER, POISONPOWDER, STUN_SPORE, SLUDGE_BOMB
