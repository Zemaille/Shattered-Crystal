...
BrunoGroup:
	...
	db 42, YAMASK,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
...
BlackbeltGroup:
	...
	db 27, YAMASK,  DOUBLE_KICK, MEDITATE, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 36, YAMASK,  DOUBLE_TEAM, HI_JUMP_KICK, MUD_SLAP, SWIFT
	db -1 ; end
