...
BrunoGroup:
	...
	db 42, DRAKLOAK,  PURSUIT, QUICK_ATTACK, DIG, DETECT
	db 42, YAMASK,  SWAGGER, DOUBLE_KICK, NO_MOVE, NO_MOVE
	db 42, COFAGRIGUS, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
...
BrockGroup:
	...
	db 42, GALVANTULA,    BITE, SURF, PROTECT, SPIKE_CANNON
...
LtSurgeGroup:
	...
	db 40, DRAGALGE,  SCREECH, NO_MOVE, SWIFT, EXPLOSION
...
ErikaGroup:
	...
	db 46, TORTERRA, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
...
SchoolboyGroup:
	...
	db 35, DRAGALGE,  SCREECH, NO_MOVE, ROLLOUT, LIGHT_SCREEN
...
CooltrainerMGroup:
	...
	db 35, TORTERRA, WRAP, TOXIC, ACID, RAZOR_LEAF
	...
	db 39, TORTERRA, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	...
	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, TORTERRA, WRAP, TOXIC, ACID, RAZOR_LEAF
...
HikerGroup:
	...
	db 38, STEELIX,    DIG, IRON_TAIL, SANDSTORM, NO_MOVE
	db -1 ; end
	...
	db 34, MACHOKE,    KARATE_CHOP, NO_MOVE, HEADBUTT, DIG
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, YAMASK,  DOUBLE_KICK, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; BLACKBELT_T (3)
	db "KENJI@", TRAINERTYPE_MOVES
	db 33, ONIX,       NO_MOVE, ROCK_THROW, TOXIC, DIG
	db 38, MACHAMP,    HEADBUTT, SWAGGER, THUNDERPUNCH, NO_MOVE
	db 33, STEELIX,    EARTHQUAKE, ROCK_THROW, IRON_TAIL, SANDSTORM
	db 36, YAMASK,  NO_MOVE, NO_MOVE, MUD_SLAP, SWIFT
	db -1 ; end

	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 27, COFAGRIGUS, COMET_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
PicnickerGroup:
	...
	db 30, GROTLE, SLEEP_POWDER, POISONPOWDER, STUN_SPORE, SLUDGE_BOMB
...
MysticalmanGroup:
	...
	db 25, DRAGALGE,  SCREECH, NO_MOVE, THUNDER, ROLLOUT
	db -1 ; end
