...
BrockGroup:
	...
	db 44, ONIX,       BIND, ROCK_SLIDE, NO_MOVE, SANDSTORM
...
ErikaGroup:
	...
	db 42, RHYPERIOR,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
...
SchoolboyGroup:
	...
	db 32, RHYPERIOR,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
