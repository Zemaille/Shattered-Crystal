...
MortyGroup:
	...
	db 21, GASTLY,     LICK, NO_MOVE, MEAN_LOOK, CURSE
	db 21, HAUNTER,    SPORE, MIMIC, CURSE, NO_MOVE
	db 25, GENGAR,     SPORE, SHADOW_BALL, MEAN_LOOK, NO_MOVE
	db 23, HAUNTER,    NO_MOVE, MEAN_LOOK, MIMIC, NO_MOVE
	db -1 ; end
...
Rival1Group:
	...
	db 20, HAUNTER,    LICK, NO_MOVE, MEAN_LOOK, CURSE
...
LtSurgeGroup:
	...
	db 40, MAGNETON,   LOCK_ON, NO_MOVE, SWIFT, NO_MOVE
	db 40, DRAGALGE,  SCREECH, NO_MOVE, SWIFT, EXPLOSION
...
SchoolboyGroup:
	...
	db 38, MAGNETON,   NO_MOVE, THUNDER_WAVE, LOCK_ON, SWIFT
	db -1 ; end
...
JanineGroup:
	...
	db 39, CLODSIRE,   FORESIGHT, NO_MOVE, GUST, PSYCHIC_M
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, DELPHOX,   NO_MOVE, FOCUS_ENERGY, NO_MOVE, NO_MOVE
...
FisherGroup:
	...
	db 25, CURSOLA,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, CURSOLA,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, YAMASK,  DOUBLE_KICK, NO_MOVE, NO_MOVE, FOCUS_ENERGY
	db -1 ; end
	...
	db 25, MACHOP,     LEER, FOCUS_ENERGY, KARATE_CHOP, NO_MOVE
...
MysticalmanGroup:
	...
	db 23, HAUNTER,    LICK, SPORE, MEAN_LOOK, CURSE
