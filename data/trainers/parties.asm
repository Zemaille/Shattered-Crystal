...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, RAGE, NO_MOVE, BITE
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, RAGE, NO_MOVE, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, NO_MOVE
	db 38, FERALIGATR, RAGE, NO_MOVE, SCARY_FACE, SLASH
	db -1 ; end
...
BrockGroup:
	...
	db 41, RHYHORN,    NO_MOVE, SCARY_FACE, EARTHQUAKE, HORN_DRILL
...
YoungsterGroup:
	...
	db 21, MAMOSWINE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, MAMOSWINE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, MAMOSWINE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, MILOTIC,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 39, MILOTIC,    KINGS_ROCK,   SURF, STOMP, GUILLOTINE, BLIZZARD
	...
	db 32, MILOTIC,    BUBBLEBEAM, STOMP, GUILLOTINE, PROTECT
...
BugCatcherGroup:
	...
	db 25, DELPHOX,   NO_MOVE, FOCUS_ENERGY, NO_MOVE, RAGE
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, NO_MOVE, PSYCHIC_M
	db 45, FERALIGATR, RAGE, NO_MOVE, SCARY_FACE, SLASH
	db -1 ; end
