...
BirdKeeperGroup:
	...
	db 40, MAGNEZONE, FURY_ATTACK, DETECT, FLY, SLASH
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, DELPHOX,   FURY_ATTACK, FOCUS_ENERGY, NO_MOVE, RAGE
	...
	db 32, DELPHOX,   FURY_ATTACK, PURSUIT, NO_MOVE, DOUBLE_TEAM
...
FisherGroup:
	...
	db 34, MAGMORTAR,    SUPERSONIC, WATERFALL, NO_MOVE, FURY_ATTACK
	db 34, MAGMORTAR,    SUPERSONIC, WATERFALL, NO_MOVE, FURY_ATTACK
	...
	db 39, MAGMORTAR,    ENDURE, NO_MOVE, FURY_ATTACK, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, MAGMORTAR,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 34, MAGMORTAR,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
