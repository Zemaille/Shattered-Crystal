...
; BattleTowerMons group 1
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, HYPER_BEAM, SHADOW_BALL, NO_MOVE
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KANGASKHAN
	db MIRACLEBERRY
	db NO_MOVE, HYPER_BEAM, EARTHQUAKE, NO_MOVE
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db MISDREAVUS
	db FOCUS_BAND
	db PERISH_SONG, NO_MOVE, PAIN_SPLIT, SHADOW_BALL
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db HOUNDOUR
	db GOLD_BERRY
	db FAINT_ATTACK, SOLARBEAM, NO_MOVE, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db UMBREON
	db LEFTOVERS
	db PROTECT, TOXIC, MUD_SLAP, NO_MOVE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, NO_MOVE, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STEELIX
	db GOLD_BERRY
	db NO_MOVE, IRON_TAIL, SWAGGER, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ARCANINE
	db BRIGHTPOWDER
	db FLAMETHROWER, NO_MOVE, HYPER_BEAM, IRON_TAIL
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 35000
	...
	db EXEGGUTOR
	db LEFTOVERS
	db HYPER_BEAM, PSYCHIC_M, TOXIC, NO_MOVE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, NO_MOVE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db AZUMARILL
	db MYSTIC_WATER
	db SURF, BLIZZARD, NO_MOVE, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db MILTANK
	db KINGS_ROCK
	db EARTHQUAKE, THUNDER, NO_MOVE, SURF
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db WIGGLYTUFF
	db GOLD_BERRY
	db HYPER_BEAM, BLIZZARD, FIRE_BLAST, NO_MOVE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 3
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, THUNDER_WAVE, NO_MOVE, MUD_SLAP
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db JYNX
	db GOLD_BERRY
	db BLIZZARD, LOVELY_KISS, NO_MOVE, NO_MOVE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HOUNDOOM
	db CHARCOAL
	db FLAMETHROWER, CRUNCH, SHADOW_BALL, NO_MOVE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db CROBAT
	db GOLD_BERRY
	db NO_MOVE, CONFUSE_RAY, TOXIC, WING_ATTACK
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, NO_MOVE, ICY_WIND, STRENGTH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db URSARING
	db GOLD_BERRY
	db HEADBUTT, PROTECT, NO_MOVE, LEER
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db ARCANINE
	db CHARCOAL
	db FLAME_WHEEL, LEER, BODY_SLAM, NO_MOVE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GALVANTULA
	db GOLD_BERRY
	db CURSE, NO_MOVE, ANCIENTPOWER, ROCK_SMASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, NO_MOVE, FLY, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db HOUNDOOM
	db MIRACLEBERRY
	db REST, CRUNCH, NO_MOVE, FLAMETHROWER
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db CROBAT
	db LEFTOVERS
	db CONFUSE_RAY, NO_MOVE, HYPER_BEAM, TOXIC
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db GIRAFARIG
	db SCOPE_LENS
	db NO_MOVE, CRUNCH, PSYCHIC_M, EARTHQUAKE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, SURF, RAIN_DANCE, NO_MOVE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db ARTICUNO
	db GOLD_BERRY
	db BLIZZARD, HYPER_BEAM, NO_MOVE, ICY_WIND
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db HOUNDOOM
	db MIRACLEBERRY
	db FLAMETHROWER, CRUNCH, NO_MOVE, REST
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db HERACROSS
	db FOCUS_BAND
	db NO_MOVE, MEGAHORN, EARTHQUAKE, COUNTER
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, NO_MOVE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db HOUNDOOM
	db KINGS_ROCK
	db CRUNCH, FLAMETHROWER, FAINT_ATTACK, NO_MOVE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 58000
	...
	db GYARADOS
	db BRIGHTPOWDER
	db SURF, THUNDERBOLT, HYPER_BEAM, NO_MOVE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 8
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDER_WAVE, THUNDERBOLT, IRON_TAIL, NO_MOVE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db JYNX
	db QUICK_CLAW
	db LOVELY_KISS, BLIZZARD, NO_MOVE, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db MOLTRES
	db CHARCOAL
	db FLAMETHROWER, NO_MOVE, STEEL_WING, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db MIRACLEBERRY
	db HYPER_BEAM, REST, EARTHQUAKE, NO_MOVE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db TOGEKISS
	db BRIGHTPOWDER
	db NO_MOVE, SHADOW_BALL, HYPER_BEAM, THUNDERPUNCH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, NO_MOVE, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db FLAREON
	db MINT_BERRY
	db HYPER_BEAM, FLAMETHROWER, SHADOW_BALL, NO_MOVE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MILTANK
	db LEFTOVERS
	db MILK_DRINK, EARTHQUAKE, NO_MOVE, BODY_SLAM
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db GLISCOR
	db PINK_BOW
	db THUNDERBOLT, HYPER_BEAM, NO_MOVE, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db NOIVERN
	db QUICK_CLAW
	db TOXIC, SLUDGE_BOMB, NO_MOVE, GIGA_DRAIN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 10
	...
	db HOUNDOOM
	db MINT_BERRY
	db CRUNCH, FLAMETHROWER, NO_MOVE, REST
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, EARTHQUAKE, HYPER_BEAM, NO_MOVE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db JOLTEON
	db BRIGHTPOWDER
	db THUNDERBOLT, NO_MOVE, THUNDER_WAVE, IRON_TAIL
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SNEASEL
	db SCOPE_LENS
	db SLASH, BLIZZARD, NO_MOVE, FAINT_ATTACK
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LANTURN
	db QUICK_CLAW
	db SURF, RAIN_DANCE, NO_MOVE, CONFUSE_RAY
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 30000
