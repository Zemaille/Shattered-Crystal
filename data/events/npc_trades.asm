...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, ODDISH,     ONIX,       "ROCKY@@@@@@", $96, $66, PERSIM_BERRY, 48926, "KYLE@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_HAPPY,     CORSOLA,    MAGNEMITE,  "VOLTY@@@@@@", $98, $88, CHERI_BERRY, 29189, "TIM@@@@@@@@", TRADE_GENDER_EITHER
