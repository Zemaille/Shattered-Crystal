...
.o:        db FERALIGATR, FURRET, KITTRING, BRELOOM, SENTRET, STANTLER, SWABLU, ALTARIA, GALVANTULA, JOLTIK, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, YANMEGA, SNORLAX, KABUTO, KABUTOPS, DRAKLOAK, WARTORTLE, BLASTOISE, MAGNEZONE, CUBONE, SABRAWLER, KANGASKHAN, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, TURTWIG, WEEZING, MARILL, AZUMARILL, ELECTRODE, SHROOMISH, ABYSSEEL, -1
