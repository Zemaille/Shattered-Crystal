...
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, WARTORTLE, BLASTOISE, MAGNEZONE, CUBONE, MAROWAK, KANGASKHAN, -1
...
.sa_za:    db RHYHORN, PUPITAR, CORSOLA, HITMONLEE, ZAPDOS, JOLTEON, ZANGOOSE, MUNCHLAX, -1 ; RHYDON should lead this list
.shi_ji:   db SEADRA, SHELLDER, VAPOREON, DEWGONG, -1
.su_zu:    db SUICUNE, STARMIE, SCYTHER, ZUBAT, DELPHOX, HYPNO, DROWZEE, -1
...
.hi_bi_pi: db CLEFFA, FENNEKIN, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, SEEDOT, WEEZING, MARILL, AZUMARILL, ELECTRODE, SHROOMISH, MANTINE, -1
