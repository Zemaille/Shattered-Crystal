...
.o:        db FERALIGATR, FURRET, KITTRING, TANGROWTH, SENTRET, STANTLER, SWABLU, ALTARIA, GALVANTULA, JOLTIK, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, TURTWIG, WEEZING, MARILL, AZUMARILL, ELECTRODE, TANGELA, ABYSSEEL, -1
