...
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SWABLU, ALTARIA, OMASTAR, OMANYTE, -1
...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, BRAIXEN, DEWPIDER, PHANPY, HONCHKROW, GOLDUCK, GOLBAT, GOLEM, GRAVELER, DUDUNSPARCE, -1
