...
.tsu_du:   db SHUCKLE, -1
.te_de:    db DIGLETT, CURSOLA, DELIBIRD, HOUNDOUR, AMPHAROS, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db RIOLU, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, GOOMY, BLISSEY, PHANTUMP, TREVENANT, SPIRITOMB, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, TURTWIG, WEEZING, MARILL, AZUMARILL, DRAGALGE, SHROOMISH, MANTINE, -1
