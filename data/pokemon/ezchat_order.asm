...
.u:        db ARCANINE, SUDOWOODO, NUZLEAF, SHIFTRY, WOOPER, SWINUB, -1
.e:        db SKARMORY, AIPOM, ESPEON, COFAGRIGUS, ELEKID, ELECTABUZZ, ENTEI, -1
.o:        db FERALIGATR, FURRET, OCTILLERY, BRELOOM, SENTRET, STANTLER, SWABLU, ALTARIA, OMASTAR, OMANYTE, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, WARTORTLE, BLASTOISE, MAGNEZONE, TYRUNT, TYRANTRUM, KANGASKHAN, -1
.ki_gi:    db SUNFLORA, CATERPIE, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, KINGDRA, MILOTIC, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, FEEBAS, GRANBULL, CROBAT, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db RIOLU, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PHANTUMP, TREVENANT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db CLEFFA, FENNEKIN, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, SKRELP, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, SEEDOT, WEEZING, MARILL, AZUMARILL, DRAGALGE, SHROOMISH, MANTINE, -1
.mi:       db DRATINI, MEW, MEWTWO, MILTANK, -1
.mu:       db MISDREAVUS, SMOOCHUM, -1
.me:       db MEGANIUM, DITTO, TENTACOOL, MAREEP, -1
.mo:       db FLAAFFY, CLODSIRE, TANGELA, -1
