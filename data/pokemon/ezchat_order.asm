...
.u:        db ARCANINE, SUDOWOODO, SKIPLOOM, JUMPLUFF, WOOPER, SWINUB, -1
.e:        db SKARMORY, SNEASLER, ESPEON, OVERQWIL, WEAVILE, ELECTABUZZ, ENTEI, -1
.o:        db FERALIGATR, FURRET, KITTRING, TANGROWTH, SENTRET, STANTLER, SWABLU, ALTARIA, VENOMOTH, VENONAT, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, YANMEGA, SNORLAX, KABUTO, KABUTOPS, DRAKLOAK, WARTORTLE, BLASTOISE, MAGNEZONE, CUBONE, MAROWAK, KANGASKHAN, -1
...
.sa_za:    db RHYHORN, PUPITAR, CORSOLA, QWILFISH, ZAPDOS, JOLTEON, MANKEY, MUNCHLAX, -1 ; RHYDON should lead this list
...
.hi_bi_pi: db GLACEON, FENNEKIN, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, LEAFEON, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.he_be_pe: db BAYLEEF, NOIBAT, NOIVERN, HERACROSS, HOUNDOOM, PERSIAN, FARIGIRAF, -1
.ho_bo_po: db ZOROARK, HOOTHOOT, PIDGEY, PONYTA, SLIGGOO, PORYGON, PORYGON2, -1
.ma:       db MAGCARGO, SLUGMA, QUILAVA, HOPPIP, WEEZING, MARILL, AZUMARILL, ELECTRODE, TANGELA, MANTINE, -1
.mi:       db DRATINI, MEW, DELIBIRD, MILTANK, -1
