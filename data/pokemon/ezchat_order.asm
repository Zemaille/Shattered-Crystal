...
.o:        db FERALIGATR, FURRET, OCTILLERY, BRELOOM, SENTRET, STANTLER, SWABLU, ALTARIA, ARMALDO, ANORITH, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, YANMEGA, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, WARTORTLE, BLASTOISE, MAGNEZONE, TYRUNT, TYRANTRUM, KANGASKHAN, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGBY, SYLVEON, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
