	...
	; tm/hm learnset
	tmhm RETURN, PROTECT, TOXIC, REST, SNORE, SLEEP_TALK, HYPER_BEAM, HIDDEN_POWER, SUBSTITUTE, CURSE, WATER_PULSE, RAIN_DANCE, ROCK_SLIDE, DRAGON_PULSE, THUNDERBOLT, THUNDER, SLUDGE_BOMB, SURF, WHIRLPOOL, WATERFALL, POISON_JAB, FIRE_PUNCH, THUNDERPUNCH, DRAGON_CLAW, EARTHQUAKE, FLAMETHROWER, ICE_BEAM, FIRE_BLAST, BLIZZARD, FOCUS_BLAST, SCALD, IRON_HEAD, IRON_TAIL, FLASH_CANNON
	; end
