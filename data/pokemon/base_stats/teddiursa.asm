	...
	; tm/hm learnset
	tmhm RETURN, PROTECT, TOXIC, REST, SNORE, SLEEP_TALK, HYPER_BEAM, HIDDEN_POWER, SUBSTITUTE, CURSE, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, THUNDER_FANG, ICE_FANG, FIRE_FANG, STRENGTH, CUT, FURY_CUTTER, X_SCISSOR, SNARL, ROCK_SMASH, AERIAL_ACE, SHADOW_CLAW, BULLDOZE, EARTHQUAKE, SLUDGE_BOMB, ROCK_SLIDE, IRON_HEAD, SWORDS_DANCE, HEADBUTT
	; end
