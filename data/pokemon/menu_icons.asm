...
MonMenuIcons:
	...
	db ICON_FIGHTER     ; SHROOMISH
	db ICON_FIGHTER     ; BRELOOM
	...
	db ICON_BIRD        ; DODUO
	db ICON_BIRD        ; DODRIO
	db ICON_LAPRAS      ; RIOLU
	db ICON_LAPRAS      ; LUCARIO
	db ICON_BLOB        ; GRIMER
	db ICON_BLOB        ; MUK
	...
	db ICON_HUMANSHAPE  ; INKAY
	db ICON_HUMANSHAPE  ; MALAMAR
	db ICON_SHELL       ; FEEBAS
	db ICON_SHELL       ; MILOTIC
	db ICON_VOLTORB     ; VOLTORB
	db ICON_VOLTORB     ; DRAGALGE
	db ICON_ODDISH      ; EXEGGCUTE
	db ICON_ODDISH      ; EXEGGUTOR
	db ICON_MONSTER     ; IMIPUP
	db ICON_MONSTER     ; SABRAWLER
	db ICON_FIGHTER     ; YAMASK
	db ICON_FIGHTER     ; COFAGRIGUS
	...
	db ICON_PIKACHU     ; LEAFEON
	db ICON_CLEFAIRY    ; GLACEON
	db ICON_JIGGLYPUFF  ; SYLVEON
	...
	db ICON_MONSTER     ; KLEAVOR
	db ICON_MONSTER     ; TOGEKISS
	db ICON_FISH        ; SPIRITOMB
	db ICON_BUG         ; SCIZOR
	db ICON_BUG         ; SHUCKLE
	...
	db ICON_FIGHTER     ; DREEPY
	db ICON_FIGHTER     ; DRAKLOAK
	db ICON_HUMANSHAPE  ; DRAGAPULT
